...
const PurchaseOverview = () => {
  return (
    <div className=" bg-gray-300 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-20 border border-gray-100 flex flex-col gap-y-4 p-5 w-7/12">
      <div className="">
