...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-blue-900 via-blue-700 to-purple-800">
      ...
      <div className="bg-opacity-70 bg-gray-800 p-10 rounded-xl shadow-2xl max-w-md w-full space-y-8 text-white">
        <div className="text-center mb-8">
        ...
        <div className="mt-6 text-center text-sm">
          ...
          <div className="mt-4 flex justify-center space-x-4">
            <button className="flex items-center bg-blue-600 hover:bg-blue-700 transition py-2 px-4 rounded-lg">
              <Image src="/facebook.png" alt="Facebook" width={20} height={20} className="mr-2" />
              Facebook
            </button>
            <button className="flex items-center bg-red-600 hover:bg-red-700 transition py-2 px-4 rounded-lg">
        ...
        <div className="mt-8 text-center text-sm">
          <p>Don't have an account? <a href="/signup" className="text-purple-400 hover:underline">Register here</a></p>
        </div>
      </div>
    </div>
  );
